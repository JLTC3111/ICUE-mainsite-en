import{r as x,j as it}from"./index-CsKE2mT8.js";import{V as T,aJ as W,S as w,bA as rt,bB as at,bC as nt,aO as ot,bd as O,w as ue,a$ as m,bD as de,aY as Te,a5 as Ge,Z as ke,g as Ve,bo as oe,U as le,a_ as k,af as lt,aU as Re,e as We,am as Ye,bl as Y,aV as Xe,a3 as ct,bE as ut,H as Ke,ab as Ze,B as dt,f as Pe,bF as Fe,b0 as ft,b as ht,o as vt,aZ as pt,a4 as A}from"./three.module-IOgEEaSI.js";/**
 * postprocessing v6.39.2 build Sun Jun 28 2026
 * https://github.com/pmndrs/postprocessing
 * Copyright 2015-2026 Raoul van Rüschen
 * @license Zlib
 */var mt=(()=>{const e=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),t=new Float32Array([0,0,2,0,0,2]),s=new dt;return s.setAttribute("position",new Pe(e,3)),s.setAttribute("uv",new Pe(t,2)),s})(),B=class Ee{static get fullscreenGeometry(){return mt}constructor(t="Pass",s=new Te,i=new Ge){this.name=t,this.renderer=null,this.scene=s,this.camera=i,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthBlit=!1,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(t){if(this.rtt===t){const s=this.fullscreenMaterial;s!==null&&(s.needsUpdate=!0),this.rtt=!t}}set mainScene(t){}set mainCamera(t){}setRenderer(t){this.renderer=t}isEnabled(){return this.enabled}setEnabled(t){this.enabled=t}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(t){let s=this.screen;s!==null?s.material=t:(s=new ke(Ee.fullscreenGeometry,t),s.frustumCulled=!1,this.scene===null&&(this.scene=new Te),this.scene.add(s),this.screen=s)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(t){this.fullscreenMaterial=t}getDepthTexture(){return null}setDepthTexture(t,s=de){}render(t,s,i,r,a){throw new Error("Render method not implemented!")}setSize(t,s){}initialize(t,s,i){}dispose(){for(const t of Object.keys(this)){const s=this[t];(s instanceof O||s instanceof Ke||s instanceof Ze||s instanceof Ee)&&this[t].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},gt=class extends B{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(e,t,s,i,r){const a=e.state.buffers.stencil;a.setLocked(!1),a.setTest(!1)}},St=`#ifdef COLOR_WRITE
#include <common>
